    ...
    useEffect(()=>{
        const getProductById = async () =>{
            try {
                ...
                setNpp(response.data.npp);
                setNpwp(response.data.npwp);
                setAwal_masuk(response.data.awal_masuk);
                setStatus_pegawai(response.data.status_pegawai);
                ...
                setStatus_nikah(response.data.status_nikah);
                setPendidikan(response.data.pendidikan);
                setTipe_bpjs(response.data.tipe_bpjs);
                setNo__bpjs(response.data.no_bpjs);
            } catch (error) {
                if(error.response) {
